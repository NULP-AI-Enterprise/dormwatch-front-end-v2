      ...
      <aside className="hidden md:flex md:flex-col md:w-56 lg:w-64 bg-stone-800 border-r border-stone-700 min-h-screen shrink-0">
        ...
        <div className="p-4">
          ...
          <button
            ...
            className="flex items-center gap-3 px-3 py-2 text-base font-semibold transition-colors text-stone-300 hover:bg-stone-700 hover:text-stone-50 w-full text-left"
          >
